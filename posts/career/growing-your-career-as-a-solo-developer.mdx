...
This software was a no-code solution. It software ran smoothly, but being a school that offered
electronic curriculum provided through a platform that _we had little control of_ made me
...
I stumbled across [syntax.fm](https://syntax.fm/) and my life as a developer was changed. Listening
to [Wes Bos](https://wesbos.com/) and [Scott Tolinski](https://levelup.video/) discuss web
development trends and technology really struck a chord with me &mdash; and it provided a productive
way to pass time during a commute!
...
#### Suggestion: Listen to AudioBooks

Additionally, I capitalized on the commute time by listening to various audio books, some of which
include:
